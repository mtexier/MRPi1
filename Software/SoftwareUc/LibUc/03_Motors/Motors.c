...
void Motor_right(MotorDir_TypeDef Motor_Direction, uint32_t Motor_Speed)
{
  ...
  {
	// State low
    HBRIDGE_DIR1_PORT->BSRRH = HBRIDGE_DIR1_PIN;
  }
  else
  {
	// State hight
    HBRIDGE_DIR1_PORT->BSRRL = HBRIDGE_DIR1_PIN;
  }
...
void Motor_left(MotorDir_TypeDef Motor_Direction, uint32_t Motor_Speed)
{
  ...
  {
    // State low
    HBRIDGE_DIR2_PORT->BSRRH = HBRIDGE_DIR2_PIN;
  }
  else
  {
	  // State hight
    HBRIDGE_DIR2_PORT->BSRRL = HBRIDGE_DIR2_PIN;
  }
